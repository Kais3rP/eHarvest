...
export const fetchPersonalProducts = () => async (dispatch) => {
  try {
    const res = await fetch("/user/get-user-products")
    const data = await res.json()
...
export const fetchPersonalData = () => async (dispatch) => {
  const res = await fetch("/user/get-personal-data")
  const data = await res.json()
...
export const fetchUserDataUpdate = (updatedData) => async (dispatch) => {
  ...
  try {
    const res = await fetch("/user/update-personal-data", {
      method: "POST",
      headers: {
...
export const asyncUpdateUserPicture = (userPic) => async (dispatch) => {
  try {
    const res = await fetch("/user/upload-personal-picture", {
      method: "POST",
      body: userPic,
    })
